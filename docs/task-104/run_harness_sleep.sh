...
APP=/tmp/claude/detour-dd-task104/Build/Products/Debug/Detour.app
LOG=$S/harness.log
...
open -n "$APP" --env DETOUR_DATA_DIR=DetourVerify \
  ...
  --env DETOUR_SLEEP_SHOW_BUDGET=${BUDGET:-20} \
  --env DETOUR_SLEEP_SHOW_BUDGET_GRACE_SECONDS=${GRACE:-30}
